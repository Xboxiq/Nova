  ...
  return (
    <Section label="Typography">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 20, alignItems: 'start' }}>
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 22, padding: 28, boxShadow: 'var(--shadow-1)', display: 'flex', flexDirection: 'column', gap: 22 }}>
        ...
        <div dir="rtl" style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 22, padding: 28, boxShadow: 'var(--shadow-1)', display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <button className="i-lift" style={{ height: 40, padding: '0 20px', borderRadius: 999, border: 'none', background: 'var(--ink)', color: 'var(--on-ink)', fontSize: 14, fontWeight: 600, cursor: 'pointer' }}>ابدأ الآن</button>
            <button className="i-soft" style={{ height: 40, padding: '0 18px', borderRadius: 999, border: '1px solid var(--border-strong)', background: 'var(--surface)', color: 'var(--text)', fontSize: 14, fontWeight: 500, cursor: 'pointer' }}>اعرف المزيد</button>
          </div>
        </div>
      </div>
    </Section>
