...
export default function EnterpriseAIPipeline() {
  ...
  return (
    <div className="bg-[#090909] border border-white/[0.08] rounded-[14px] overflow-hidden font-sans w-[620px] mx-auto">
      {/* Header */}
      ...
      <svg
        ...
        className="block"
        role="img"
        aria-label="Agent pipeline. A user query flows into a Pinecone semantic search, then into a Claude LLM agent, which dispatches three actions: an email draft, a CRM update, and a report generation."
      >
        <defs>
          <marker
            id="ma"
      ...
      <div className="border-t border-white/[0.06] px-[18px] py-[9px] h-[52px]">
        <div className="flex gap-2 items-start h-full">
          ...
          <div className="relative flex-1 overflow-hidden h-full" aria-live="polite" aria-atomic="true">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="font-mono text-[11px] text-white/[0.42] leading-[1.55] absolute inset-0"
              >
