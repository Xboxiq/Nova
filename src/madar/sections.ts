...
export const madarSections: MadarSection[] = [
  ...
  },
  {
    ...
    titleAr: "الطاقة",
    family: "patterns",
    description: "A meter read as an instrument, consumption against its own normal, the tariff ladder, a prepaid balance read as days to the top-up, and the night floor that says whether something is running while you sleep.",
    descriptionAr: "عدّاد يُقرأ كجهاز، واستهلاك مقابل معتاده، وسُلّم الشرائح، ورصيدٌ مسبقٌ يُقرأ أيامًا إلى يوم الشحن، وأرضيّةُ الليل التي تقول إن كان شيءٌ يعمل وأنت نائم.",
