...
export function Energy() {
  ...
  return (
    <Section label="Energy">
      ...
      <SpecRow name="Night Floor: ما يعمل وأنت نائم" specimen={<NightFloor />}>
        الأرضيّة أقلّ ساعةٍ يشربها البيت بين الواحدة والخامسة فجرًا، وللبيت أرضيّةٌ معتادةٌ كما له مجموعٌ معتاد. ليلةٌ واحدةٌ عاليةٌ شذوذ؛ ثلاثٌ متتاليةٌ جهازٌ لم يُطفأ — وهذا ما لا يقوله رقم: متوسّطُ أربع عشرة ليلةً يُخفي السلسلة، والسلسلةُ هي الحُكم. فالليالي أعمدةٌ قراءتُها عند الحافّة، والمعتادُ حزامٌ مخطَّطٌ على المقياس نفسه، وما علا الحزامَ أخذ اللون. والرسمُ محطّةُ تبويبٍ واحدة تكشف الأسهمُ قيمَها — ما يناله الفأر بالتمرير تناله لوحةُ المفاتيح بالسهم.
      </SpecRow>

      <SpecRow name="Appliance Area: القوّة × الساعات" specimen={<ApplianceArea />}>
        سخّانُ الماء أقوى ما في البيت والثلاجةُ أضعفُه، ولا هذا ولا تلك أكبرُ شاربٍ — لأن الطاقةَ قوّةٌ في زمن، ورقمُ الكيلوواط يُخفي أيَّ العاملَين صنعه. فكلُّ جهازٍ مستطيلٌ على محورَين واحدَين: ساعاتُه على عرض اليوم، وواطاتُه ارتفاعًا، ومساحتُه طاقتُه؛ والشبكةُ خلفه مقطوعةٌ بحيث كلُّ خانةٍ كيلوواط ساعة، فالمقدارُ معدودٌ لا مقدَّر. والساعاتُ هي الضابط: منزلقٌ لكلّ جهاز، فـ«ساعةٌ أقلّ من التكييف» صندوقٌ يضيق بعددٍ من الخانات تراه.
      </SpecRow>
      </SpecList>
    </Section>
  );
