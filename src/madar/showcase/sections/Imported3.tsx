    ...
    <Section label="Imported III">
      ...
      <SpecList>
        ...
        <SpecRow name="زُجاجٌ بلا أرضٍ يُضبِّبُها، وحُكمٌ لي تسحَبُه لَقطةٌ لا تَستقِرّ" bare specimen={
          ...
          <br /><br />
          <b>وهذا هو القرارُ الذي أثارَته الرفعةُ السابقةُ في خطِّ جوجل، ويُجابُ بالجوابِ نفسِه:</b> هذا التطبيقُ لا يَبلُغُ مُضيفًا خارجيًّا، <b>والمكوِّنُ ليس موضعَ البَدءِ بذلك</b>. <b>والصورةُ أثقلُ حالًا من الخط</b>، لأنها فوقَ ذلك ملفُّ غيرِنا برُخصةِ غيرِنا، <b>فلم تُنسَخْ إلى المستودعِ كذلك</b>. فرُسِمَت الأرضُ محلّيًّا: ثلاثُ تَفتُّحاتٍ شعاعيّةٍ في الطيفِ الدافئِ الذي يَعِدُ به اسمُ الصورةِ الأصليّة، <b>بلا طلبٍ ولا بايت</b>. <b>وإعادةُ الصورةِ لمالكٍ يُريدُ الرَّبطَ الخارجيَّ وسمُ <code>img</code> واحد.</b>
          <br /><br />
