      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(300px,1fr))', gap: 20, alignItems: 'start' }}>
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 6, padding: 24, display: 'flex', flexDirection: 'column', gap: 18 }}>
          <label style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            ...
            <input placeholder="e.g. Madar Studio" className="i-input" style={{ height: 44, borderRadius: 6, border: '1px solid var(--border-strong)', background: 'var(--surface-2)', color: 'var(--text)', padding: '0 14px', fontSize: 15 }} />
          ...
          <label style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            ...
            <input defaultValue="team@madar" className="i-input-danger" style={{ height: 44, borderRadius: 6, border: '1px solid var(--danger)', background: 'var(--surface-2)', color: 'var(--text)', padding: '0 14px', fontSize: 15 }} />
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, height: 44, borderRadius: 6, border: '1px solid var(--border-strong)', background: 'var(--surface-2)', padding: '0 8px 0 14px', color: 'var(--text-3)' }}>
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 6, padding: 24, display: 'flex', flexDirection: 'column', gap: 20 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
            ...
            <button aria-label="Toggle weekly digest" onClick={() => setOn((v) => !v)} style={{ position: 'relative', width: 44, height: 26, borderRadius: 6, border: 'none', padding: 0, flex: 'none', cursor: 'pointer', background: on ? 'var(--accent)' : 'var(--border-strong)', transition: 'background 220ms' }}>
              <span style={{ position: 'absolute', top: 2, insetInlineStart: on ? 20 : 2, width: 22, height: 22, borderRadius: '50%', background: '#fff', transition: 'inset-inline-start 220ms cubic-bezier(0.34,1.45,0.64,1)' }} />
            </button>
          </div>
          ...
          <div>
            ...
            <div style={{ position: 'relative', display: 'inline-flex', background: 'var(--surface-2)', borderRadius: 6, padding: 4, border: '1px solid var(--border)' }}>
              <span style={{ position: 'absolute', top: 4, insetInlineStart: 4, width: 104, height: 32, borderRadius: 6, background: 'var(--surface)', border: '1px solid var(--border)', transform: `translateX(${seg * 104 * m}px)`, transition: 'transform 340ms cubic-bezier(0.34,1.45,0.64,1)' }} />
              {['Overview', 'Board', 'Timeline'].map((label, i) => (
                <button key={label} onClick={() => setSeg(i)} style={{ position: 'relative', zIndex: 1, width: 104, height: 32, border: 'none', background: 'none', fontSize: 13, fontWeight: 600, color: 'var(--text)', cursor: 'pointer', borderRadius: 6 }}>{label}</button>
              ))}
            </div>
          </div>
        </div>
        ...
        {/* popover listbox */}
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 6, padding: 24, display: 'flex', flexDirection: 'column', gap: 14 }}>
          <div style={{ fontSize: 13.5, fontWeight: 500, color: 'var(--text-2)' }}>Select — popover listbox</div>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 44, borderRadius: 6, border: '1px solid var(--accent)', background: 'var(--surface-2)', padding: '0 14px', fontSize: 15, boxShadow: '0 0 0 3px var(--accent-soft)' }}>
            Riyadh (GMT+3)
          ...
          <div style={{ borderRadius: 6, border: '1px solid var(--border)', background: 'var(--surface)', padding: 8, display: 'flex', flexDirection: 'column', gap: 2 }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 36, borderRadius: 6, padding: '0 12px', fontSize: 14, background: 'var(--accent-soft)', fontWeight: 600 }}>
              Riyadh (GMT+3)
