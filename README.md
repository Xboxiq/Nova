...
مكتبة React عربية أولًا تضم 72 نمط واجهة تفاعليًا ضمن نظام تصميم واحد. بُنيت للاستخدام الشخصي الاحترافي، مع RTL افتراضي، وLTR كامل، ومظهرين فاتح وداكن، ومكوّنات NOVA أصلية إلى جانب روابط مصادر الإلهام على 21st.dev.
...
- بحث فوري، تصفية حسب القسم، تبديل فاتح وداكن، وتحويل RTL وLTR.
...
عقد المشروع ومسار القراءة في [DESIGN.md](./DESIGN.md)، والمصدر التصميمي المتكامل في [NOVA Design OS](./design-system/nova-design-os/DESIGN.md)، والتوكنز المحمولة في `design-system/nova-design-os/tokens/`. سجل المنتج في [PRODUCT.md](./PRODUCT.md)، واتفاقية العمل في [AGENTS.md](./AGENTS.md). ملف `nova-ui-library.html` نسخة مستقلة قديمة للرجوع فقط، وليس مصدر الحقيقة الحالي.
