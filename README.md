...
خطوة واحدة يدوية لمرة واحدة: من **Settings → Pages** في المستودع، اضبط المصدر على **GitHub Actions**.

بدونها لا يفشل شيء ظاهريًا — وهذه هي المشكلة. أول نشر مرّ بكل خطواته خضراء بينما كان العنوان الحيّ يخدم **جذر المستودع** لا البناء: `README.md` و`package.json` يرجعان 200، و`index.html` يشير إلى `/src/main.tsx`، فالصفحة بيضاء. لذلك يختم الـworkflow بخطوة تجلب العنوان المنشور وتفشل صراحةً إن لم يكن ما يخدمه هو البناء.
