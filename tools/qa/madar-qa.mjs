...
const PACK_SECTIONS = ["madar-nova-instruments", "madar-energy", "madar-color-tokens", "madar-admin-access", "madar-consequence", "madar-dispatch", "madar-photographed", "madar-boards", "madar-glasswork", "madar-projectwork", "madar-directions", "madar-matrix", "madar-imported", "madar-imported-2", "madar-imported-3"];
const AA = 4.5;
